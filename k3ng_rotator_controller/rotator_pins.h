...
#define rotate_ccw 11            // goes high to activate rotator L (CCW) rotation - pin 2 on Yaesu connector
#define rotate_cw_ccw 12         // goes high for both CW and CCW rotation
...
#define button_cw A1             // normally open button to ground for manual CW rotation (schematic pin: A2)
...
#define rotator_analog_az A4     // reads analog azimuth voltage from rotator - pin 4 on Yaesu connector
